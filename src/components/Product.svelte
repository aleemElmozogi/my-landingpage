    ...
    <div class="flex flex-col gap-10 sm:gap-14 md:gap-24 flex-1 items-center justify-center pb-10 md:pb-14">
        <div class="flex flex-col gap-2">
            ...
            <ProductCard  {productFeature} {index}> 
                    {#if index === 0 }
                    Experience a bigginer excercise 
                    <span class="text-indigo-400 font-medium">master</span>
                     class
                        {:else if index ===1}
                        Lay the foundation for 
                        <span class="text-indigo-400 font-medium">routine</span><br/>

                        {:else}
                        Workouts specific to your 
                        <span class="text-indigo-400 font-medium">enviroment</span> 
                        and 
                        <span class="text-indigo-400 font-medium">expertires</span>
