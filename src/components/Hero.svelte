...
<SectionWrapper>
    <Header/>
    <div class="flex flex-col gap-10 flex-1 items-center justify-center pb-10 md:pd-14">
        ...
        <p class="text-xl sm:text-2xl md:text-3xl text-center max-w-[1000px] mx-auto w-full">
            Less thinking & more doing. We're the the trainer in your pocket full of
            <br/>
            <span class="italic"> personlized workouts, exercise explanations, analytics</span>
            <br/>
             and much more.
        </p>
        <CTAs  dark={false}/>
